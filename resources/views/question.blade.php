    ...
    <section class='conteudos'>
        ...
        Pontos 0
            ...
            <ol id='alternativas'>
                ...
                <li id='b' value='1B' class='respostas correcao' onClick='verificarSeAcertou(this, this)'></li>
                <li id='c' value='1C' class='respostas correcao' onClick='verificarSeAcertou(this, this)'></li>
                <li id='d' value='1D' class='respostas correcao' onClick='verificarSeAcertou(this, this)'></li>

            </ol>
        </div>
    </article>
    
        <img src="./assets/WaveBottom.png" class="WaveBottom" alt="" srcset="">
...
<div id="outModal">
    <div id="modal-promocao" class="modal-container">
            ...
            <img src="/assets/3e-logo-color.png" class="Logo" alt="">
                <h2 id="show"></h2>
                <p id="explicação"></p>
                <button type="submit" class="btnModal" id="close">Continuar</button>
        </div>
    </div>
</div>
